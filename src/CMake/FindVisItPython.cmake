...
if(PYTHONINTERP_FOUND)
    ...
    execute_process(COMMAND "${PYTHON_EXECUTABLE}" "-c" "import sys; import pip; sys.stdout.wriate(pip.__version__)"
                    OUTPUT_VARIABLE PYTHON_PIP_VERSION
                    ERROR_VARIABLE  ERROR_FINDING_PYTHON_PIP_MODULE
                    COMMAND_ERROR_IS_FATAL ANY)
    message(STATUS "PYTHON_PIP_VERSION:       ${PYTHON_CONFIG_LIBRARY}")
